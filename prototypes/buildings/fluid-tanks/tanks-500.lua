...
ITEM {
    type = "item",
    name = "py-tank-500",
    icon = "__pyindustry__/graphics/icons/py-tank-500.png",
    icon_size = 32,
    flags = {},
    subgroup = "py-storage-tanks",
    order = "a-a[py-items]",
    place_result = "py-tank-500",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {hardness = 0.2, mining_time = 3, result = "py-tank-500"},
    max_health = 100,
    ...
    pictures = {
        picture = {
            sheet = {
                filename = "__pyindustry__/graphics/entity/py-tank-500/py-tank-500.png",
                priority = "extra-high",
                frames = 2,
                width = 66,
                height = 79,
                shift = {0.0, -0.0},
                hr_version = {
                    filename = "__pyindustry__/graphics/entity/py-tank-500/hr-py-tank-500.png",
                    priority = "extra-high",
                    frames = 2,
                    width = 133,
                    height = 157,
